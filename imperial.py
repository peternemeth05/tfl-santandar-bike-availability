...
if hux[0] != 0:
    print(f"\nHuxley bike station has {hux[0]} bikes with {hux[2]} being ebikes! \n")

if rsm[0] != 0:
    print(f"\nRSM bike station has {rsm[0]} bikes with {rsm[2]} being ebikes!\n")

if entrance[0] != 0:
    print(f"\nMain entrance bike station has {entrance[0]} bikes with {entrance[2]} being ebikes!\n")
